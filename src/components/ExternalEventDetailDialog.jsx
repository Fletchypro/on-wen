            ...
            >
              <div className="md:col-span-1 h-36 relative overflow-hidden">
                {event.image ? (
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-slate-600/85 via-slate-700/80 to-slate-900/85" />
                )}
                ...
                <div className="flex flex-col sm:flex-row gap-2 pt-2">
                  {(() => {
                    ...
                    return buyTicketsUrl ? (
                      <Button
                        asChild
                        className="flex-1 bg-sky-600 hover:bg-sky-500 text-white font-semibold gap-2"
                      >
